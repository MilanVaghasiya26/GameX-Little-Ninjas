...
const Addition = () => {
    ...
    const getObject = () => {
        HttpService.get(API_CONFIG.path.mathObject).then((response) => {
        ...
        <>
            ...
            <div className='module-container bg full-viewport-height overflow--hidden-y flex justify__content--center  align__items--center'>
                <div className='flex mt--25 align__items--center flex--column justify__content--between '>
                    <img
                        className='position--relative postion--top-55 width--200 responsive--mathoperation'
                        src={mathopration}
                    />
                    ...
                    <div className='flex'>
                        {details.length > 0 &&
                            details.map((key, i) => (
                                <div
                                    className='text--black  height--80 flex justify__content--center align__items--center width--80 b-radius--lg pointer no--border  '
                                    key={i}
                                >
                                    <img
...
export default withRouter(Addition);
