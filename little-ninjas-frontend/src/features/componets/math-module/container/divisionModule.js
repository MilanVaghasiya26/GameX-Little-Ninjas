...
const Division = () => {
    ...
    const getObject = () => {
        HttpService.get(API_CONFIG.path.divisionobject).then((response) => {
        ...
        <>
            ...
            <div className='module-container bg full-viewport-height overflow--hidden-y flex justify__content--center  align__items--center'>
                <div className='flex mt--25 align__items--center flex--column justify__content--between '>
                    <img
                        className='position--relative postion--top-55 width--200 responsive--divide'
                        src={mathopration}
                    />
                    ...
                    <div className='text--center line-height--28 text--black opacity mt--30'>
